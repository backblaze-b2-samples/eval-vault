...
| `B2_REGION` | Your bucket region, e.g. `us-west-004` (the S3 endpoint is derived from this) |
| `ANTHROPIC_API_KEY` | Your Anthropic API key (required to run evals) |
