...
# eval-vault uploads eval-definition YAMLs and JSON/text artifacts — not
# media. The allowlist is scoped to those text formats.
ALLOWED_TYPES = {
    "text/yaml",
    "application/x-yaml",
    "text/plain",
...
MIME_EXTENSION_MAP: dict[str, set[str]] = {
    ...
    "text/plain": {"txt", "text", "log", "md", "yaml", "yml"},
    "text/csv": {"csv"},
