...
from app.runtime import evals, files, health, metrics, upload  # noqa: E402
...
app = FastAPI(
    title="Eval Vault API",
    description=(
        "Run LLM evals against N Claude models and archive every input, "
        "output, score, and trace as immutable JSON on Backblaze B2"
    ),
    version="0.1.0",
    lifespan=lifespan,
)
